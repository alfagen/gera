...
ActiveRecord::Schema[8.1].define(version: 2025_12_25_000001) do
  ...
  create_table "gera_currency_rate_history_intervals", force: :cascade do |t|
    ...
    t.datetime "interval_from", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "interval_to", precision: nil, null: false
  ...
  create_table "gera_exchange_rates", force: :cascade do |t|
    t.boolean "auto_rate", default: false
    t.string "calculator_type", default: "legacy", null: false
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.string "in_cur", limit: 4, null: false
    t.bigint "income_payment_system_id", null: false
    t.boolean "is_enabled", default: false, null: false
    t.integer "maxamount_cents", default: 0
    t.integer "minamount_cents", default: 0
    t.string "out_cur", limit: 4, null: false
    t.bigint "outcome_payment_system_id", null: false
    t.datetime "updated_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.float "value", null: false
    t.index ["calculator_type"], name: "index_gera_exchange_rates_on_calculator_type"
  ...
  create_table "gera_external_rate_snapshots", force: :cascade do |t|
    t.datetime "actual_for", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "gera_payment_systems", force: :cascade do |t|
    ...
    t.integer "total_computation_method", default: 0
    t.integer "transfer_comission_payer", default: 0
  ...
  create_table "gera_target_autorate_settings", force: :cascade do |t|
    t.decimal "autorate_from", precision: 10, scale: 4
    t.decimal "autorate_to", precision: 10, scale: 4
    t.datetime "created_at", null: false
    t.integer "exchange_rate_id", null: false
    t.integer "position_from"
    t.integer "position_to"
    t.datetime "updated_at", null: false
    t.index ["exchange_rate_id"], name: "index_gera_target_autorate_settings_on_exchange_rate_id", unique: true
  end
  ...
  add_foreign_key "gera_target_autorate_settings", "gera_exchange_rates", column: "exchange_rate_id", on_delete: :cascade
end
