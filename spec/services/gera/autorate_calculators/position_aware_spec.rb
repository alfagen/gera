    ...
    RSpec.describe PositionAware do
      ...
      describe '#call' do
        ...
        context 'UC-2: есть разрыв между позициями' do
          ...
          let(:external_rates) do
            [
              manul_rate(1.0), # pos 1
              manul_rate(1.2), # pos 2
              manul_rate(1.4), # pos 3
              manul_rate(1.6), # pos 4
              manul_rate(2.5), # pos 5
              manul_rate(2.6), # pos 6
              manul_rate(2.7), # pos 7
              manul_rate(2.8), # pos 8
              manul_rate(2.9), # pos 9
              manul_rate(3.0)  # pos 10
            ]
          end
        ...
        context 'UC-3: целевая позиция 1' do
          ...
          let(:external_rates) do
            [
              manul_rate(2.5), # pos 1
              manul_rate(2.8), # pos 2
              manul_rate(3.0)  # pos 3
            ]
          end
        ...
        context 'UC-4: позиция выше с очень близкой комиссией' do
          ...
          let(:external_rates) do
            [
              manul_rate(1.0),    # pos 1
              manul_rate(1.5),    # pos 2
              manul_rate(2.0),    # pos 3
              manul_rate(2.4999), # pos 4
              manul_rate(2.5),    # pos 5
              manul_rate(2.8)     # pos 6
            ]
          end
        ...
        context 'UC-6: адаптивный GAP для плотного рейтинга' do
          ...
          it 'использует адаптивный GAP' do
            ...
            expect(calculator.call).to be_within(0.0001).of(2.49975)
          end
        end
        ...
        context 'UC-6: минимальный GAP' do
          ...
          it 'использует минимальный GAP' do
            ...
            expect(calculator.call).to be_within(0.0001).of(2.49995)
          end
        end
        ...
        context 'UC-8: наш обменник в рейтинге' do
          ...
          let(:external_rates) do
            [
              manul_rate(1.0, changer_id: 101), # pos 1
              manul_rate(1.5, changer_id: 102), # pos 2
              manul_rate(2.0, changer_id: 999), # pos 3 - наш
              manul_rate(2.3, changer_id: 103), # pos 4
              manul_rate(2.5, changer_id: 104), # pos 5
              manul_rate(2.8, changer_id: 105)  # pos 6
            ]
          end
        ...
        context 'UC-9: манипуляторы с аномальными курсами' do
          ...
          let(:external_rates) do
            [
              manul_rate(0.1), # pos 1 - манипулятор
              manul_rate(0.2), # pos 2 - манипулятор
              manul_rate(0.3), # pos 3 - манипулятор
              manul_rate(2.0), # pos 4 - нормальный
              manul_rate(2.5), # pos 5
              manul_rate(2.6), # pos 6
              manul_rate(2.7), # pos 7
              manul_rate(2.8), # pos 8
