...
module Gera
  RSpec.describe CbrRatesWorker do
    ...
    def mock_cbr_response
      ...
      allow(CbrRatesWorker).to receive(:new).and_return(worker)
    end
  end
end
